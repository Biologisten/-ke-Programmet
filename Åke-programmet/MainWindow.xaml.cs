...
namespace Åke_programmet
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void Set_values(int id)  //Sets values from DB to boxes in UI
        {
            if (test.Get_info(id.ToString()) != null)
            {
                Library.Data Values = test.Get_info(id.ToString());
        ...
        {
            int n = Listview.SelectedIndex + 1;
            Set_values(n);
        }
